...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../SeatPreview-master/js/main.js":[function(require,module,exports) {
/**
 * main.js
...
(function (window) {
  ...
  var support = {
    ...
    tiltRotation = {
      rotateX: 25,
      // a relative rotation of -25deg to 25deg on the x-axis
  ...
  function initEvents() {
    // select a seat
    var onSeatSelect = function onSeatSelect(ev) {
    ...
    var onTiltCtrlClick = function onTiltCtrlClick() {
      // if tilt is enabled..
      if (tilt) {
        disableTilt();
      } else {
    ...
    var onSelectSeats = function onSelectSeats() {
  ...
  function previewSeat(seat) {
    ...
    var st = window.getComputedStyle(seat.parentNode, null),
      tr = st.getPropertyValue('-webkit-transform') || st.getPropertyValue('-moz-transform') || st.getPropertyValue('-ms-transform') || st.getPropertyValue('-o-transform') || st.getPropertyValue('transform') || 'Either no transform set, or browser doesn´t do getComputedStyle';
    if (tr === 'none') return;
    var values = tr.split('(')[1],
      ...
      minRotY_1 = 0,
      maxRotY_1 = 20,
      // min and max values for y rotation
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../SeatPreview-master/js/main.js"], null)
//# sourceMappingURL=/main.69a18f36.js.map